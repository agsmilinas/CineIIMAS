...
let data= 
		"Pelicula: "+ movie +"\n"+
		"Horario: " + horario +"\n"+
		"Número de boletos: "+ num +"\n"+
		"Código confirmación: " + makeid(15)


$(".id_mail")[0].value = "CineIIMAS";
$(".correo_mail")[0].value = mail;
$(".asunto_mail")[0].value = "CineIIMAS: Confirmación Compra Boletos";
$(".mensaje_mail")[0].value = data;
setTimeout(function(){
	let url = "/sendMail/"+mail
	    $('#emailForm').attr('action', url).submit();
